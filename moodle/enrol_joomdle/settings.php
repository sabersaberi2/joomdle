...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('enrol_joomdle/currency', get_string('currency', 'enrol_joomdle'), '', get_string('irr', 'enrol_joomdle'), $paypalcurrencies));// مهدی آنیلی
