...
$string['defaultrole_desc'] = 'Select role which should be assigned to users during Joomdle enrolments';
...
$string['status'] = 'Allow Joomdle enrolments'; // مهدی آنیلی
...
$string['joomdle:manage'] = 'Manage enrolments';
?>
