 ...
 * @package		Joomdle
 */
class JFormFieldSocialgroupcategory extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since	1.6
	 */
	protected $type = 'Socialgroupcategory';
	...
	protected function getOptions()
	{
		...
		$cats_results = $dispatcher->trigger('onGetSocialGroupCategories', array());
